<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Jenis Kontrak</h2>
        </div>
    </x-slot>

    <div class="py-8">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('kontrak.update', $jenis_kontrak) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text"
                               name="nama_kontrak"
                               id="nama_kontrak"
                               value="{{ old('nama_kontrak', $jenis_kontrak->nama_kontrak) }}"
                               autofocus
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number"
                                   ...
                                   id="jam_kerja_sehari"
                                   value="{{ old('jam_kerja_sehari', $jenis_kontrak->jam_kerja_sehari) }}"
                                   min="1" max="24"
                                   placeholder="8"
